...
import { FileService, User, UserService } from "laerte_fernandes-sdk";
...
// definindo o tipo como User.Detailed porém sobreescrevendo os tipo de data que eram string para Moment
type UserFormType = {
  createdAt: Moment;
  updatedAt: Moment;
  birthdate: Moment;
...
export default function UserForm(props: userFormProps) {
  ...
  return (
    <Form
      ...
      onFinish={async (userForm: User.Input) => {
        setLoading(true);
        //if (!form.name) window.alert("o campo de nome é obrigatório");
        //console.log(form);
    ...
    >
      <Row gutter={24} align="middle">
        <Col xs={24} lg={4}>
          <Row justify={"center"}>
            <ImageCrop rotate={true} shape={"round"} grid={true} aspect={1}>
              <Upload
                maxCount={1}
                onRemove={() => {
                  setAvatar("");
